...
$csvFile = fopen('ffd_weather_data.csv', 'r');
...
function bulkInsert($conn, $data) {
    ...
    $sql = "REPLACE INTO ffd_weather (id, dateTime, temp, feels_like, temp_min, temp_max, pressure, humidity, cloud, rain_1h, rain_3h) VALUES " . implode(',', $values);
