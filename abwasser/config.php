...
$config = [
    ...
    'database' => [
        ...
        'password' => 'rq*6X4s82',        // ← Ihre originalen Werte
    ...
    'dashboard' => [
        ...
        // Dezimalstellen für Anzeige - ANGEPASST für 1 Dezimalstelle
        'decimal_places' => [
            'wasserstand' => 1,         // 0.1 cm (bleibt bei 1)
            'durchflussrate' => 1,      // 0.1 l/s (geändert von 3 auf 1)
            'totalizer' => 1,           // 0.1 m³ (geändert von 2 auf 1)
            'sensor_strom' => 1,        // 0.1 mA (bleibt bei 1)
            'consumption' => 1          // 0.1 m³ (geändert von 3 auf 1)
        ],
